...
![Java Core](https://img.shields.io/badge/-Java-003f5c?style=for-the-badge&logo=appveyor) ![Spring Web MVC](https://img.shields.io/badge/-Spring_Web_MVC-003f5c?style=for-the-badge&logo=appveyor) ![Spring WebFlux](https://img.shields.io/badge/-Spring_WebFlux-003f5c?style=for-the-badge&logo=appveyor) ![Redis](https://img.shields.io/badge/-Redis-003f5c?style=for-the-badge&logo=appveyor) ![Apache Kafka](https://img.shields.io/badge/-Apache_Kafka-003f5c?style=for-the-badge&logo=appveyor) ![Spring Cloud](https://img.shields.io/badge/-Spring_Cloud-003f5c?style=for-the-badge&logo=appveyor) ![S3](https://img.shields.io/badge/-S3-003f5c?style=for-the-badge&logo=opencv) ![DOCKER](https://img.shields.io/badge/-DOCKER-003f5c?style=for-the-badge&logo=docker) ![GIT](https://img.shields.io/badge/-GIT-003f5c?style=for-the-badge&logo=git) ![HTML](https://img.shields.io/badge/-HTML-003f5c?style=for-the-badge&logo=appveyor) ![Helm](https://img.shields.io/badge/Helm-C71A36?style=for-the-badge&logo=apachemaven&logoColor=white)

---
### Законченные проекты

- :balloon:  [java-my-bank-app](https://github.com/ism-ektb/my-bank-app) - Микросервисное приложение с веб-интерфейсом «Банк». Написано на реактивном стеке. Развёртывание с использованием Kubernetes, Helm, включающее трейсинг и метрики запросов, аллерты и централизованное логирование
- :balloon:  [java-my-market-app](https://github.com/ism-ektb/my-market-app) - Реактивное приложение "Витрина магазина" с веб-интерфейсом, авторизацией пользователей и возможностью безопасного подключения внешних модулей. Для примера подключен макет модуля платежей.
